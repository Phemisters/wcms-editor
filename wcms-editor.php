...
<script src="https://cdn.jsdelivr.net/npm/trumbowyg@2.31.0/dist/plugins/resizimg/trumbowyg.resizimg.min.js"></script>
        ...
        <script src="{$Wcms->url('plugins/wcms-editor/js/jquery-resizable.min.js')}" type="text/javascript"></script>
        <script src="{$Wcms->url('plugins/wcms-editor/js/trumbowyg.upload.js')}" type="text/javascript"></script>
        <script src="{$Wcms->url('plugins/wcms-editor/js/admin.js')}" type="text/javascript"></script>
EOT;
        $args[0] .= $script;
    }
    return $args;
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/trumbowyg@2.31.0/dist/plugins/table/ui/trumbowyg.table.min.css">
        <link rel="stylesheet" href="{$Wcms->url('plugins/wcms-editor/css/admin.css')}" type="text/css" media="screen">
EOT;
        $args[0] .= $script;
    }
    return $args;
