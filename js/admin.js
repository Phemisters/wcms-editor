...
.on('tbwchange', function(){console.info('onChange '+$('#'+$(this).attr('id'))); editElements[$(this).attr('id')] = $('#'+$(this).attr('id')).trumbowyg('html');})
.on('tbwchange', function(){console.info('onFocus'); clearTimeout();})
.on('tbwblur', function(){console.info('onBlur'); const that = $(this); timeoutSave = setTimeout(function () { saveData(that) }, 200); });
